...
<a
	...
	on:click
	class="{colourClass} rounded-lg border-black transition-all duration-500 hover:bg-black hover:text-white-pure hover:border-white py-2 px-4 border-white border {textClass} {textColourClass} font-martina cursor-pointer {fullWidth ? 'w-full block text-center' : 'inline'}"
	role="button"
>
	{label}
</a>
